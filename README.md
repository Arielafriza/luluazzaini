...
<body id="body">
    ...
    <div class="card-container" id="mainCard">
        ...
        <div id="hiddenMessage">
            <p style="color: #1a1a1a;"><strong>Bab Rahasia:</strong> Allah telah menulis nama kita berdua di Lauhulmahfus, sebuah catatan takdir yang tak berubah. aku yakin, kita adalah jodoh yang telah ditentukan, dan tidak ada yang dapat memisahkan kita. lulu adalah hadiah terindah yang Allah berikan kepada ai, dan ai akan selalu bersyukur atas kehadiran lulu. Bersama, kita akan menjalani hidup ini dengan penuh cinta, iman, dan harapan.</p>
        ...
        <p style="font-size: 0.8em; color: var(--main-text-color);">💖</p>
    </div>
